...
$newformatdate = $date->format("F, j, Y");

$today = new DateTime();
$agecalulation = $today->diff($date);
$age = $agecalulation->y;


$_SESSION['birthdate'] = $newformatdate;
$_SESSION['age'] = $age;
$_SESSION['sex'] = $sex;
        ...
        <form action="thank-you.php" method="POST">
          ...
          <fieldset>
            ...
            <select name="program">
              ...
              <option value="is" required>Information Systems</option>
              <option value="se" required>Software Engineering</option>
              <option value="ds"required>Data Science</option>
            </select>
